...
__attribute__((weak, alias("Default_Handler"))) void VAVD_LVD_VOVD_VUVD_IRQHandler(void);
...
__attribute__((weak, alias("Default_Handler"))) void NVMC_IRQHandler(void);
...
__attribute__((weak, alias("Default_Handler"))) void ADC0_1_RDCM_IRQHandler(void);
...
__attribute__((weak, alias("Default_Handler"))) void HPDF_INT4_IRQHandler(void);
...
__attribute__((weak, alias("Default_Handler"))) void FFT_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void ESC_SYNC0_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void ESC_SYNC1_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void ESC_IRQHandler(void);
...
__attribute__((weak, alias("Default_Handler"))) void OTP_IRQHandler(void);
...
__attribute__((weak, alias("Default_Handler"))) void CPU_DCACHE_ERR_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void CPU_ICACHE_ERR_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void VCORE_OVER_UNDER_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void TIMER0_Channel_BRK_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void TIMER7_Channel_BRK_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void DSI_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void PKCAU_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void ESC_BRIDGE_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void EDIM_IRQHandler(void);
...
{
    DRV_CHIP_JumpIntoVectorAddress(0x1FEFF000);
}
